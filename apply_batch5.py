...
with open('/Users/clawdbot/.openclaw/workspace/builds/qck-case-studies/batch5_competitors.json') as f:
    raw = json.load(f)
...
for slug, new_section in replacements.items():
    ...
    try:
        ...
        continue
    replaced = False
    for pat in [BOILERPLATE_PATTERN, BOILERPLATE_PATTERN2, CHALLENGE_PAT2]:
